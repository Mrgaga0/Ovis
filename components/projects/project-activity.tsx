    ...
    <div className="space-y-4">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1 space-y-1">
          <p className="text-sm font-medium">새 작업 생성</p>
          <p className="text-sm text-muted-foreground">소셜 미디어 포스트 작성 작업이 생성되었습니다.</p>
        </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1 space-y-1">
          ...
          <p className="text-sm text-muted-foreground">블로그 포스트 작성이 완료되었습니다.</p>
        </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1 space-y-1">
          ...
          <p className="text-sm text-muted-foreground">이메일 템플릿 작성이 진행 중입니다.</p>
        </div>
